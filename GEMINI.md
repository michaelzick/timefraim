...
**Also update the two sibling files** — [CLAUDE.md](CLAUDE.md) and [AGENTS.md](AGENTS.md) — in the same edit so every harness reads the same truth. If the three files ever diverge, treat it as a bug and reconcile.
