...
**Also update the two sibling files** — [AGENTS.md](AGENTS.md) and [GEMINI.md](GEMINI.md) — in the same edit so every harness reads the same truth. If the three files ever diverge, treat it as a bug and reconcile.
